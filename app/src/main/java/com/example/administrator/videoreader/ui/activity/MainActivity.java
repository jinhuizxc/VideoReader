...
import com.example.administrator.videoreader.utils.BlurImageUtils;
import com.example.administrator.videoreader.utils.DataCleanManager;
...
public class MainActivity extends BaseActivity implements BottomNavigationBar.OnTabSelectedListener, View.OnClickListener {
    ...
    private Fragment mVideoHomeFragment;
    ...
    public void onTabSelected(int position) {
        switch (position) {
            ...
            case 1:
                ...
                break;
            case 2:
                switchContent(mVideoHomeFragment);
                break;
//            case 3:
