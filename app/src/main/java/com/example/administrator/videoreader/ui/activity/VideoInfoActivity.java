...
import com.example.administrator.videoreader.ui.fragment.VideoCommentFragment;
import com.example.administrator.videoreader.ui.fragment.VideoInfoFragment;
...
public class VideoInfoActivity extends SwipeBackActivity implements ViewPager.OnPageChangeListener {
    ...
    private void initView() {
        ...
        VideoCommentFragment videoCommentFrag = new VideoCommentFragment();
    ...
    private void initRxBus() {
        ...
        RxBus.getDefault().toObservableWithCode(
                RxConstants.LOADED_VIDEO_PIC_CODE, String.class)
